*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_SWITCH_CRIT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_SWITCH_CRIT     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_SWITCH_CRIT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_SWITCH_CRIT_EXTRACT
TOTAL = ZMV_SWITCH_CRIT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_SWITCH_CRIT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_SWITCH_CRIT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_SWITCH_CRIT_EXTRACT
TOTAL = ZMV_SWITCH_CRIT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_SWITCH_CRIT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_SWITCH_CRIT'
...
TOTAL = ZMV_SWITCH_CRIT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_SWITCH_CRIT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_SWITCH_CRIT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_SWITCH_CRIT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_SWITCH_CRIT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_SWITCH_CRIT_EXTRACT
TOTAL = ZMV_SWITCH_CRIT_TOTAL
