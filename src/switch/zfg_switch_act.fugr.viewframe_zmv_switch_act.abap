*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_SWITCH_ACT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_SWITCH_ACT      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_SWITCH_ACT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_SWITCH_ACT_EXTRACT
TOTAL = ZMV_SWITCH_ACT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_SWITCH_ACT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_SWITCH_ACT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_SWITCH_ACT_EXTRACT
TOTAL = ZMV_SWITCH_ACT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_SWITCH_ACT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_SWITCH_ACT'
...
TOTAL = ZMV_SWITCH_ACT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_SWITCH_ACT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_SWITCH_ACT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_SWITCH_ACT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_SWITCH_ACT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_SWITCH_ACT_EXTRACT
TOTAL = ZMV_SWITCH_ACT_TOTAL
