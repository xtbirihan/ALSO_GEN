*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_PARAM_MAST
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_PARAM_MAST      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_PARAM_MAST'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_PARAM_MAST_EXTRACT
TOTAL = ZMV_PARAM_MAST_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_PARAM_MAST'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_PARAM_MAST-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PARAM_MAST_EXTRACT
TOTAL = ZMV_PARAM_MAST_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_PARAM_MAST-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_PARAM_MAST'
...
TOTAL = ZMV_PARAM_MAST_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_PARAM_MAST-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_PARAM_MAST-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_PARAM_MAST'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_PARAM_MAST-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PARAM_MAST_EXTRACT
TOTAL = ZMV_PARAM_MAST_TOTAL
