*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_PARAM_CUST
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_PARAM_CUST      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_PARAM_CUST'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_PARAM_CUST_EXTRACT
TOTAL = ZMV_PARAM_CUST_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_PARAM_CUST'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_PARAM_CUST-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PARAM_CUST_EXTRACT
TOTAL = ZMV_PARAM_CUST_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_PARAM_CUST-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_PARAM_CUST'
...
TOTAL = ZMV_PARAM_CUST_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_PARAM_CUST-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_PARAM_CUST-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_PARAM_CUST'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_PARAM_CUST-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PARAM_CUST_EXTRACT
TOTAL = ZMV_PARAM_CUST_TOTAL
